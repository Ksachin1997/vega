...
export type DepositsOptionalAttributes =
  | 'id'
  | 'seq_no'
  | 'txid'
  | 'coin'
  ...
  | 'createdAt'
  | 'updatedAt';
export type DepositsCreationAttributes = Optional<
  DepositsAttributes,
  DepositsOptionalAttributes
>;

export class Deposits
  extends Model<DepositsAttributes, DepositsCreationAttributes>
  implements DepositsAttributes
{
  id!: number;
  seq_no?: number;
  error!: boolean;
